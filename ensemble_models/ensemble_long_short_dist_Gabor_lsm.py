...
def long_short_Gabor_ensemble_lsm(in_conn, num_partitions=1, Nz=12):
    ...
    Wins_s, Wlsm_s, conn_P1_s, _ = initWeights_receptive_field_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, conv_H, conv_W, filters.shape[0], window, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
    Wins_l, Wlsm_l, _, conn_P2_l = initWeights_receptive_field_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, conv_H, conv_W, filters.shape[0], window, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
