...
from lsm_weight_definitions import initWeights_short_long_dist_partition, initWeights_receptive_field_short_long_dist_partition
...
if __name__ == "__main__":
    ...
    #Wins_s, Wlsm_s, conn_P1_s, _ = initWeights_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
    #Wins_l, Wlsm_l, _, conn_P2_l = initWeights_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
    Wins_s, Wlsm_s, conn_P1_s, _ = initWeights_receptive_field_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, inH, inW, inCh, window, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
    Wins_l, Wlsm_l, _, conn_P2_l = initWeights_receptive_field_short_long_dist_partition(w_in, w_lsm, in_conn, in_sz, inH, inW, inCh, window, long_dist, num_partitions, inh_fr=inh_fr, Nx=Nx, Ny=Ny, Nz=Nz)
